...
A("Marmiadoise",			LONG_SWORD,						(const char *)0,
	4000L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
...
A("Soulthief",			LONG_SWORD,						(const char *)0,
	4000L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_CHAOTIC, PM_KNIGHT, NON_PM, TIER_A, (ARTG_NOGEN|ARTG_INHER|ARTG_MAJOR|ARTG_FXALGN),
	NO_MONS(),
	ATTK(AD_PHYS, 20, 10), NOFLAG,
	PROPS(DRAIN_RES, SEARCHING), (ARTP_SEEK),
	PROPS(), NOFLAG,
...
A("The Trident of Neptune",			TRIDENT,						"wave-etched %s",
	5000L, SHELL_MAT, MZ_DEFAULT, WT_DEFAULT,
	A_NONE, NON_PM, NON_PM, TIER_B, (ARTG_GIFT),
	MONS(vsMA(MA_PRIMORDIAL | MA_ET), vsMV(MV_TELEPATHIC | MV_RLYEHIAN)),
	ATTK(AD_PHYS, 10, 20), (ARTA_HATES|ARTA_SILVER|ARTA_CANCEL),
...
A("Garcia's Saddle",				SADDLE,					(const char *)0,
	4000L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_NONE, NON_PM, NON_PM, TIER_D, NOFLAG,
	NO_MONS(),
	NO_ATTK(), NOFLAG,
...
A("Girdle of Giant Strength",			BELT_OF_ENHANCED_STRENGTH,			(const char *)0,
	10000L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_NONE, NON_PM, NON_PM, TIER_B, NOFLAG,
	NO_MONS(),
	NO_ATTK(), NOFLAG,
...
A("Vigilant Halberd",		HALBERD,					(const char *)0,
	4000L, METAL, MZ_LARGE, WT_DEFAULT,
...
A("The Rod of Dis",					MACE,				(const char *)0,
	...
	A_LAWFUL, NON_PM, NON_PM, TIER_C, (ARTG_NOGEN|ARTG_NOWISH|ARTG_MAJOR),
	NO_MONS(),
...
A("The Diadem of Amnesia",			DUNCE_CAP,			(const char *)0,
	...
	A_LAWFUL, NON_PM, NON_PM, TIER_F, (ARTG_NOGEN|ARTG_NOWISH|ARTG_MAJOR),
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(), NOFLAG,
	PROPS(), NOFLAG,
...
A("The Fire Chief Helmet",                HELMET, "Well balanced and shiny %s",
	4000L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_LAWFUL, PM_FIREFIGHTER, NON_PM, TIER_B, (ARTG_NOGEN|ARTG_NOWISH|ARTG_MAJOR),
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(FLYING), NOFLAG,
	PROPS(FIRE_RES), NOFLAG,
...
A("The Gourd of Infinity", HORN_OF_PLENTY, "Magnificent flowing %s",
	3000L, SILVER, MZ_DEFAULT, WT_DEFAULT,
	A_NEUTRAL, PM_DRUNK, NON_PM, TIER_S, (ARTG_NOGEN|ARTG_NOWISH|ARTG_MAJOR),
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(), NOFLAG,
	PROPS(DRAIN_RES, BLOCK_CONFUSION, STONE_RES), NOFLAG,
	NOFLAG, NOFLAG
),
A("The Lightsaber Prototype",					LIGHTSABER,			"custom featured lightsaber %s",
	...
	NO_MONS(),
	ATTK(AD_PHYS, 3, 8), ARTA_RETURNING,
	PROPS(ANTIMAGIC, HALF_SPDAM, REFLECTING, FLYING, TELEPORT_CONTROL), NOFLAG,
	PROPS(), NOFLAG,
	ENERGY_BOOST, NOFLAG
	),
A("The Darksaber",					LIGHTSABER,			"pitch-black lightsaber %s",
	3000L, SILVER, MZ_DEFAULT, WT_DEFAULT,
	A_CHAOTIC, PM_JEDI, NON_PM, TIER_S, (ARTG_NOGEN|ARTG_NOWISH|ARTG_MAJOR),
	NO_MONS(),
	ATTK(AD_PHYS, 3, 8), ARTA_RETURNING,
	PROPS(ANTIMAGIC, HALF_SPDAM, REFLECTING, FLYING, TELEPORT_CONTROL), NOFLAG,
	PROPS(), NOFLAG,
...
A("The Whistle of the Warden", MAGIC_WHISTLE, "Sharp sounding %s",
	1200L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_LAWFUL, PM_OFFICER, NON_PM, TIER_D, NOFLAG,
	NO_MONS(),
	ATTK(AD_PHYS, 1, 6), NOFLAG,
	PROPS(), NOFLAG,
	PROPS(ANTIMAGIC, HALF_SPDAM, HALF_PHDAM, STEALTH), NOFLAG,
	NOINVOKE, NOFLAG
),
A("The Stake of Van Helsing",        WOODEN_STAKE, "Extremely hard and sharp %s",
	1200L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_LAWFUL, PM_UNDEAD_SLAYER, NON_PM, TIER_D, NOFLAG,
	NO_MONS(),
	ATTK(AD_PHYS, 1, 0), NOFLAG,
	PROPS(), NOFLAG,
	PROPS(ANTIMAGIC), NOFLAG,
...
A("The Lockpick of Arsene Lupin", LOCK_PICK, "Expertly made %s",
    1200L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
    A_LAWFUL, PM_LOCKSMITH, NON_PM, TIER_D, NOFLAG,
    NO_MONS(),
    ATTK(AD_PHYS, 1, 6), NOFLAG,
    PROPS(), NOFLAG,
    PROPS(ANTIMAGIC), NOFLAG,
...
A("Maui's Fishhook",    GRAPPLING_HOOK, "Large %s with interesting engraving",
	1200L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_CHAOTIC, PM_DIVER, NON_PM, TIER_D, NOFLAG,
	NO_MONS(),
	ATTK(AD_PHYS, 3, 6), NOFLAG,
	PROPS(), NOFLAG,
	PROPS(MAGICAL_BREATHING), NOFLAG,
	NOINVOKE, NOFLAG
),
...
A("The Pick of the Grave",      PICK_AXE, "Sadness inducing %s",
    1200L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
    A_LAWFUL, PM_UNDERTAKER, NON_PM, TIER_D, NOFLAG,
    NO_MONS(),
    ATTK(AD_DRLI, 5, 2), NOFLAG,
    PROPS(), NOFLAG,
    PROPS(DRAIN_RES, COLD_RES), NOFLAG,
    NOINVOKE, NOFLAG
),

A("The Cudgel of Cuthbert", QUARTERSTAFF, "Humbly formed %s",
    1200L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
    A_LAWFUL, PM_PALADIN, NON_PM, TIER_D, NOFLAG,
    NO_MONS(),
    ATTK(AD_PHYS, 1, 0), NOFLAG,
    PROPS(DRAIN_RES), NOFLAG,
    PROPS(), NOFLAG,
...
A("The Crown of Saint Edward", HELM_OF_TELEPATHY, "Confessor's %s",
    1200L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
    A_LAWFUL, PM_YEOMAN, NON_PM, TIER_D, NOFLAG,
    NO_MONS(),
    NO_ATTK(), NOFLAG,
    PROPS(FAST), NOFLAG,
    PROPS(), NOFLAG,
...
A("The Golden Whistle of Nora",          MAGIC_WHISTLE, "Gold on gold %s",
    1200L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
    A_NEUTRAL, PM_ZOOKEEPER, NON_PM, TIER_D, NOFLAG,
    NO_MONS(),
    NO_ATTK(), NOFLAG,
    PROPS(), NOFLAG,
    PROPS(HALF_PHDAM), NOFLAG,
...
A("Gladius",        SHORT_SWORD, "Extremely well balanced %s",
    1200L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
    A_CHAOTIC, PM_GLADIATOR, NON_PM, TIER_D, (ARTG_GIFT),
    NO_MONS(),
    ATTK(AD_PHYS, 1, 6), NOFLAG,
    PROPS(STEALTH), NOFLAG,
    PROPS(), NOFLAG,
