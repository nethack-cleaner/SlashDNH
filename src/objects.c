...
HELM(("dunce cap", "conical hat"),
		0, 1,  1, 1,  4,   1, 10, 0, 0, CLOTH, CLR_BLUE),
HELM(("dented pot", "dented pot"),
		0, 1,  1, 1,  4,   1, 10, 0, 0, IRON, CLR_BLACK),
/* 5lo: Fire Helmet from SLASH 6, grants Fire Resistance */
HELM(("fire helmet", "red shiny helmet"),
		0, 1,  1, 1,  4,   1, 10, 0, 0, IRON, CLR_RED,O_POWER(FIRE_RES)),
...
SUIT(("leather armor"),
	1, 0,  MZ_LARGE,  ARMSZ_LIGHT, 80,  3,  40,    5, 10, 2, 0, LEATHER, HI_LEATHER),
SUIT(("asbestos jacket", "silver jacket"),
	1, 0,  MZ_LARGE,  ARMSZ_LIGHT, 2,  3,  40,    5, 10, 2, 0, MITHRIL, HI_SILVER,O_POWER(FIRE_RES)),
//ARMOR(names,
...
/*Needs encyc entry*/
CONTAINER(("ice box"),         1,   MZ_HUGE, 0, 0,   2, 250,  42, PLASTIC, CLR_WHITE),
CONTAINER(("sack", "bag"),                0, MZ_MEDIUM, 0, 0,  19,  15,   2, CLOTH, HI_CLOTH),
CONTAINER(("oilskin sack", "bag"),        0, MZ_MEDIUM, 0, 0,  18,  15, 100, CLOTH, HI_CLOTH),
CONTAINER(("bag of holding", "bag"),      0, MZ_MEDIUM, 1, 0,  19,  15, 100, CLOTH, HI_CLOTH),
CONTAINER(("portable magic bookshelf", "box"),      0, MZ_MEDIUM, 1, 0,  3,  15, 100, CLOTH, HI_CLOTH),
CONTAINER(("magic quiver", "box"),      0, MZ_MEDIUM, 1, 0,  4,  15, 100, CLOTH, HI_CLOTH),
/*Needs encyc entry*/
...
#endif
/* light sources */
TOOL(("tallow candle", "candle"),          0,   MZ_TINY, 1, 0, 0,  10,  2,  10, WAX,     CLR_WHITE),
...
TOOL(("the beginning"),    1,   MZ_TINY, 0, 0, 0,  0,  2,  20, CLOTH, CLR_GRAY),
...
TOOL(("belt of swiftness", "belt"), 0,   MZ_MEDIUM, 0, 1, 0,  14,  20,  50, LEATHER, CLR_BROWN),
TOOL(("belt of enhanced strength", "belt"), 0,   MZ_MEDIUM, 0, 1, 0,  13,  20,  50, LEATHER, CLR_BROWN),
TOOL(("belt of durability", "belt"), 0,   MZ_MEDIUM, 0, 1, 0,  13,  20,  50, LEATHER, CLR_BROWN),
TOOL(("belt of security", "belt"), 0,   MZ_MEDIUM, 0, 1, 0,  1,  20,  50, LEATHER, CLR_BROWN, O_POWER(LIFESAVED)),
TOOL(("belt of shadows", "belt"), 0,   MZ_MEDIUM, 0, 1, 0,  6,  20,  50, LEATHER, CLR_BROWN, O_POWER(STEALTH)),
TOOL(("armbands of archery", "armbands"), 0,   MZ_SMALL, 0, 1, 0,  21,  20,  50, SILVER, HI_SILVER),
...
TOOL(("armbands of skill at arms", "armbands"), 0,   MZ_SMALL, 0, 1, 0,  5,  20,  50, SILVER, HI_SILVER),
TOOL(("reflective armbands", "armbands"), 0,   MZ_SMALL, 0, 1, 0,  5,  20,  50, SILVER, HI_SILVER, O_POWER(REFLECTING)),
/* traps */
...
FOOD(("fortune cookie"),         37,   MZ_TINY,  1,  1, 0, VEGGY,  40, CLR_YELLOW),
FOOD(("pancake"),                25,   MZ_TINY,  2,  2, 0, VEGGY, 200, CLR_YELLOW),
FOOD(("doughnut"), 6,   MZ_TINY,  2,  2, 0, VEGGY,  20, CLR_BROWN),
FOOD(("tortilla"), 5,   MZ_TINY,  2,  2, 0, VEGGY,  80, CLR_WHITE),
FOOD(("cheese"), 5,   MZ_TINY,  2,  2, 0, FLESH, 250, CLR_YELLOW),
FOOD(("holy wafer"), 2,   MZ_TINY,  2,  2, 0, VEGGY, 400, CLR_WHITE),
