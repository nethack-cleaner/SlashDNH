...
static char *FDECL(string_for_opt, (char *,boolean));
static char *FDECL(string_for_env_opt, (const char *, char *,boolean));
static void FDECL(bad_negation, (const char *,boolean));
...
static boolean FDECL(special_handling, (const char *, boolean, boolean));
