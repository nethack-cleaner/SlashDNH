...
{	{"Role Player", 0}, {
	...
	{"Grand Master"},
	{"Transcendent"} },
	GOD_LATHANDER, GOD_OGHMA, GOD_HADES, /* DND */
	"Rpl", "the Camp of the Duali Tribe", "the Duali Oasis",
	PM_ROLE_PLAYER, NON_PM, NON_PM,
	PM_PELIAS, PM_CHIEFTAIN, PM_THOTH_AMON,
	PM_OGRE, PM_TROLL, S_OGRE, S_TROLL,
	ART_HEART_OF_AHRIMAN,
	MA_ELF|MA_ORC|MA_ETHEREAL|MA_HUMAN|MA_VAMPIRE, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{  11,  11,  11, 11, 11,  11 },
	{  12,  12,  12, 12, 12,  12 },
	/* Init   Lower  Higher */
	{ 20, 0,  0,10,  0, 2 },	/* Hit points */
...
{	{"Anachrononaut", 0}, {
	...
	NON_PM, NON_PM, NON_PM, NON_PM,
	ART_ANNULUS,
	MA_ELF|MA_DRAGON|MA_CLOCK|MA_GNOME, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  12, 10,  7, 10,  10,  7 },
	{  15, 17, 15, 12, 15, 15 },
...
{	{"Binder", 		 0}, {
	...
	ART_PEN_OF_THE_VOID,
	MA_GNOME|MA_FEY|MA_REPTILIAN|MA_PLANT, ROLE_MALE|ROLE_FEMALE |
...
{	{"Illithanachronounbinder", 		 0}, {
	...
	MA_HUMAN|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{  12, 10,  7, 12,  12,  7 },
	{  24, 20, 15, 20, 24, 15 },
...
{	{"Wizard", 0}, {
	...
	MA_FEY|MA_VAMPIRE|MA_REPTILIAN|MA_DRAGON|MA_ELF, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7, 10,  7,  7,  7,  7 },
	{  10, 30, 10, 20, 20, 10 },
...
{	{"Rogue", 0}, {
	...
	MA_ORC|MA_REPTILIAN, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7,  7, 10,  7,  6 },
	{  20, 10, 10, 30, 20, 10 },
...
{	{"Ranger", 0}, {
	...
	MA_GNOME|MA_REPTILIAN|MA_PLANT, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{  13, 13, 13,  9, 13,  7 },
	{  30, 10, 10, 20, 20, 10 },
...
{	{"Tourist", 0}, {
	...
	MA_HUMAN|MA_CLOCK|MA_DWARF, ROLE_MALE|ROLE_FEMALE | ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7, 10,  6,  7,  7, 10 },
	{  15, 10, 10, 15, 30, 20 },
	/* Init   Lower  Higher */
...
{	{"Troubadour", 0}, {
	...
	ART_LYRE_OF_ORPHEUS,
	MA_GNOME|MA_FEY|MA_HUMAN, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7,  7,  7, 10,  6, 10 },
	{  10, 10, 15, 25, 10, 30 },
...
{	{"Gladiator", 0}, {
	...
	GOD_SULLA, GOD_CICERO, GOD_CATILINA,	/* ANCIENT ROME */
	...
	ART_IMPERIAL_TOKEN,
	MA_ORC|MA_REPTILIAN, ROLE_MALE|ROLE_FEMALE | ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   8,  7, 7,  8,  8,  7 },
	{  20, 15, 10, 20, 25, 10 },
	/* Init   Lower  Higher */
...
{	{"Berserker", 0}, {
	...
	{"Conqueror",   "Conqueress"} },
	GOD_MITRA, GOD_CROM, GOD_SET, /* Hyborian */
	"Bez", "the Camp of the Duali Tribe", "the Duali Oasis",
	PM_BERSERKER, NON_PM, NON_PM,
	PM_PELIAS, PM_CHIEFTAIN, PM_THOTH_AMON,
	PM_OGRE, PM_TROLL, S_OGRE, S_TROLL,
	ART_HEART_OF_AHRIMAN,
	MA_ORC|MA_ETHEREAL|MA_HUMAN|MA_VAMPIRE, ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{  16,  7,  7, 15, 16,  6 },
	{  30,  6,  7, 20, 30,  7 },
...
{	{"Blind Master", 0}, {
	...
	{"Master",            0} },
	GOD_PRINCE_NEZHA, GOD_LAOZI, GOD_THE_HUNSHI_SIHOU, /* Chinese */
	"Bmt", "the Monastery of Chan-Sune",
	  "the Monastery of the Earth-Lord",
...
{	{"Drunken Master", 0}, {
	...
	{"Master",            0} },
	GOD_PRINCE_NEZHA, GOD_LAOZI, GOD_THE_HUNSHI_SIHOU, /* Chinese */
	"Drm", "the Monastery of Chan-Sune",
	  "the Monastery of the Earth-Lord",
...
{	{"Yeoman", 0}, {
	...
	{"Chancellor",     0},
	{"Regent",         0} },
	GOD_HIS_MAJESTY, GOD_HIS_HOLINESS, GOD_THE_COMMONS, /* THE THREE ESTATES */
	...
	MA_HUMAN|MA_ELF|MA_DRAGON|MA_CLOCK, ROLE_MALE | ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{  12,  7, 10, 12, 12,  7 },
	{  20, 15, 15, 20, 20, 10 },
	/* Init   Lower  Higher */
...
{	{"Zookeeper", 0}, {
	...
	{"Zookeeper",   0},
	{"Curator",     0} },
	GOD_BALDER, GOD_EDDA, GOD_HAGEN, /* NORSE MYTHOLOGY */
	...
	PM_CARNIVOROUS_APE, PM_JAGUAR, S_FELINE, S_DOG,
#if 0
	ART_LIONTAMER, ART_DIRK,
#endif
	ART_GOLDEN_WHISTLE_OF_NORA,
	MA_HUMAN|MA_ELF|MA_GNOME|MA_ORC|MA_ANIMAL|MA_REPTILIAN,
...
{	{"Paladin", 0}, {
	...
	MA_HUMAN|MA_DWARF|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{   7,  7, 10,  7,  7,  7 },
	{  20, 10, 30, 15, 20, 5 },
...
{	{"Undertaker", 0}, {
	...
	{"Crematorist",  0},
	{"Corpse Burner", 0} },
	GOD_HEL, GOD_PLUTO, GOD_THANATOS, /* Death */
	...
	MA_HUMAN , ROLE_MALE|ROLE_FEMALE | ROLE_LAWFUL|ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7,  7, 13, 10, 13,  6 },
	{  15, 20, 20, 15, 25, 10 },
	/* Init   Lower  Higher */
...
{	{"Diver", 0}, {
	...
	{"Spearfisher",   	0},
	{"Torpedo",  	0} },
	GOD_TANE, GOD_TANGAROA, GOD_WHIRO,	/* POLYNESIAN */
...
#endif
	ART_MAUI_S_FISHHOOK,
	MA_HUMAN|MA_ELF|MA_DRAGON|MA_REPTILIAN,
	ROLE_MALE|ROLE_FEMALE | ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{   8,  7, 7,  8,  8,  7 },
	{  20, 15, 10, 20, 25, 10 },
...
{	{"Ninja", "Kunoichi"}, {
	...
	{"Nikyu",     0},
	{"Ikkyu",       0} },
	GOD_JIRAIYA, GOD_TSUNADE, GOD_OROCHIMARU, /* FROM JIRAIYA GOKETSU MONOGATARI */
...
{	{"Locksmith", 0}, {
	...
	{"Keymaker",     0},
	{"Supreme Locksmith",       0} },
	GOD_NUADA, GOD_DAGDA, GOD_MORRIGAN, /* CELTIC */
...
{	{"Drunk", 0}, {
	...
	{"Winetaster",    0},
	{"Socialite",  0} },
	GOD_FUFLUNS, GOD_LIBER, GOD_OGOUN,	/* CLASSICAL GODS OF WINE */
	...
	MA_HUMAN|MA_DWARF|MA_GNOME|MA_REPTILIAN|MA_FEY|MA_ANIMAL,
	ROLE_MALE|ROLE_FEMALE | ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7, 10,  6,  6, 14, 10 },
	{  15, 15,  7, 15, 30, 15 },
...
{	{"Hacker", 0}, {
	...
	{"Senior Developer",    0},
	{"Kernel Maintainer",    0} }, 
	GOD_JOBS, GOD_WOZNIAK, GOD_GATES,
	"Hac", "university campus", "development hell",
	...
	MA_HUMAN|MA_GNOME, ROLE_MALE|ROLE_FEMALE |
	ROLE_NEUTRAL,
	/* Str Int Wis Dex Con Cha */
	{   7, 14,  6,  7,  7,  5 },
	{  10, 20, 10, 10, 30, 10 },
	...
	10, 3,-3, 2, 10, A_WIS, SPE_CURE_BLINDNESS,   -4
},
{	{"Caveman", "Cavewoman"}, {
	{"Troglodyte",  0},
	{"Aborigine",   0},
...
{	{"Knight", 0}, {
	...
	MA_DWARF|MA_HUMAN|MA_DRAGON|MA_FEY, ROLE_MALE|ROLE_FEMALE | ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{  13,  7, 14,  8, 10, 17 },
	{  30, 15, 15, 10, 20, 10 },
	/* Init   Lower  Higher */
...
{	{"Nobleman", "Noblewoman"}, {
	...
	MA_HUMAN|MA_VAMPIRE|MA_DRAGON, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{   10,10,  7, 10,  7,  7 },
	{  20, 18, 10, 20, 15, 17 },
...
{	{"Priest", "Priestess"}, {
	...
	MA_ELF|MA_HUMAN|MA_ORC|MA_DWARF, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{   7,  7, 10,  7,  7,  7 },
	{  15, 10, 30, 15, 20, 10 },
...
{	{"Pirate", 0}, {
	...
	MA_ELF|MA_CLOCK, ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  10,  7, 7,  10, 10,  7 },
	{  22, 15, 10, 22, 20, 10 },
...
{	{"Archeologist", 0}, {
	...
	ART_ITLACHIAYAQUE,
	MA_DWARF|MA_CLOCK, ROLE_MALE|ROLE_FEMALE |
	  ROLE_LAWFUL,
	/* Str Int Wis Dex Con Cha */
	{   7, 10, 10,  7,  7,  7 },
	{  20, 20, 20, 10, 20, 10 },
	...
	int rolenum, racenum, gendnum, speciesnum;
{
	...
	if(races[racenum].malenum == PM_ENT){
		...
		if(roles[rolenum].malenum == PM_WIZARD){
			return breath_type == AD_ELEC || breath_type == AD_ACID || breath_type == AD_SLEE;
		}
...
int rolenum, racenum, gendnum, alignnum;
{
	...
	if (roles[rolenum].malenum==PM_NOBLEMAN && !strcmp(races[racenum].noun,"Half-dragon")) {
		if (genders[gendnum].allow == ROLE_MALE) {
			return FALSE;
		}
	}
